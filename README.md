# Nextcloud with Hosteur Bucket Storage for Ragnarokkr.
...
*Current Version : Apache PHP 7.4, PostGres SQL 13, Redis 6.x, Nexcloud 22.2.0, OnlyOffice DocumentServer 6.4.1, ElasticSearch 6.8.18*
